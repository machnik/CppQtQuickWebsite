...
QtObject {
    ...
    readonly property var descriptionsEnglish: [
        ...
        "17. Music playback using Qt's MediaPlayer.\nShows how to play audio files (embedded in the application) using Qt's MediaPlayer component. Does not work in WebAssembly with Qt 6.10!",
        ...
        "24. Video playback.\nShows how to implement a video player using Qt's Multimedia module within a QML application. Does not work in WebAssembly with Qt 6.10!",
    ...
    readonly property var descriptionsPolish: [
        ...
        "17. Odtwarzanie muzyki za pomocą MediaPlayer w Qt.\nPokazuje, jak odtwarzać pliki dźwiękowe (osadzone w aplikacji) za pomocą komponentu MediaPlayer w Qt. Nie działa w WebAssembly z Qt 6.10!",
        ...
        "24. Odtwarzanie wideo.\nPokazuje, jak zaimplementować odtwarzacz wideo za pomocą modułu Multimedia w Qt w aplikacji QML. Nie działa w WebAssembly z Qt 6.10!",
    ...
    readonly property var descriptionsGerman: [
        ...
        "17. Musikwiedergabe mit Qt's MediaPlayer.\nZeigt, wie Audiodateien (die in der Anwendung eingebettet sind) mit Qt's MediaPlayer-Komponente abgespielt werden können. Funktioniert nicht in WebAssembly mit Qt 6.10!",
        ...
        "24. Videowiedergabe.\nZeigt, wie ein Videoplayer mit Qt's Multimedia-Modul in einer QML-Anwendung implementiert werden kann. Funktioniert nicht in WebAssembly mit Qt 6.10!",
