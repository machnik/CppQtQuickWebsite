...
- **[Qt](https://www.qt.io/download-open-source)** version `6.9.0` with pre-built binaries for:
  - for 🐧 Linux: **GCC**
  - for 🪟︎ Windows: **LLVM-MinGW**
...
```bash
export QT_BIN_GCC="$HOME/Qt/6.9.0/gcc_64"
```
...
export QT_BIN_WASM="$HOME/Qt/6.9.0/wasm_singlethread"
# ... or multi-thread:
export QT_BIN_WASM="$HOME/Qt/6.9.0/wasm_multithread"
...
setx QT_BIN_LLVM_MINGW "%USERPROFILE%\Qt\6.9.0\llvm-mingw_64"
...
```bat
:: Either single-thread:
setx QT_BIN_WASM "%USERPROFILE%\Qt\6.9.0\wasm_singlethread"
:: ... or multi-thread:
setx QT_BIN_WASM "%USERPROFILE%\Qt\6.9.0\wasm_multithread"
